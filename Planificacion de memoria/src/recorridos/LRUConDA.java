...
public class LRUConDA {
	...
	public LRUConDA(ArrayList<String> proce, int marcos, String[] lote, ArrayList<ArrayList<Pagina_M>> res, JProgressBar barra) {
		this.proce = proce;
		this.marcos = marcos;
		this.lote = lote;
		this.res = res;
	...
	private int recorrerAsync(int i, int[] k, int[] l, ArrayList<Pagina_M> ult, ArrayList<Pagina_M> ord, ArrayList<String> pf, boolean[] comienzo,
			int[] da) {
		int cantPF = 0;
		String valor = lote[i];
