...
public class LRUSinDA {
	...
	public LRUSinDA(ArrayList<String> proce, int marcos, String[] lote, ArrayList<ArrayList<Pagina_M>> res, JProgressBar barra) {
		this.proce = proce;
		this.marcos = marcos;
		this.lote = lote;
		this.res = res;
	...
	private int recorrerNoAsync(int i, int[] k, ArrayList<Pagina_M> ult, ArrayList<Pagina_M> ord, ArrayList<String> pf, boolean[] comienzo,
			int[] l) {
		int cantPF = 0;
		String valor = lote[i];
